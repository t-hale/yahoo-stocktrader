...
import (
	...
	sopsvr "stocktrader/gen/grpc/sop/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, sopEndpoints *sop.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		sopServer = sopsvr.New(sopEndpoints, nil)
	}
	...
	soppb.RegisterSopServer(srv, sopServer)
